...
public class VideoStream extends CordovaPlugin {
    public final static String BROADCAST_LISTENER = "com.kytics.ramprasad.rtmpandrtspstreamer.results";
    public final static String BROADCAST_FILTER = "com.kytics.ramprasad.rtmpandrtspstreamer";
    ...
    public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
        ...
        _args = args;
        url = args.getString(0)+"/"+args.getString(1);
        if (args.length() == 4) {
